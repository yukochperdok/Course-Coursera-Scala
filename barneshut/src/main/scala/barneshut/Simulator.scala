...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    ...
    mergeBoundary.minX = math.min(a.minX, b.minX)
    mergeBoundary.minY = math.min(a.minY, b.minY)
    mergeBoundary.maxX = math.max(a.maxX, b.maxX)
    mergeBoundary.maxY = math.max(a.maxY, b.maxY)
    mergeBoundary
  }
